// Enhanced realistic mock data for Cronos x402 transactions
...
const PROTOCOLS = [
  'VVS Finance', 'Moonlander', 'Delphi', 'Tectonic', 'Ferro Protocol',
  'CronaSwap', 'MMFinance', 'Beefy Finance', 'Fulcrom', 'Crystl Finance'
];
...
function generateDescription(instructionType: X402InstructionType, agentName: string): string {
  const descriptions: { [key in X402InstructionType]: string[] } = {
    ...
    nft_mint: [
      `NFT minted on Cronos by ${agentName}`,
