// TypeScript types for Cronos x402 Transactions and AI Agent Activities
...
export interface AIAgent {
  ...
  totalVolume: string; // Total CRO processed
  avgGasUsed: string;
...
// API Response Types
export interface CronosAPIResponse<T> {
  data: T;
  page?: number;
  pageSize?: number;
  total?: number;
